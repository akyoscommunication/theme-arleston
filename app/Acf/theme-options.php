...
if (function_exists('register_extended_field_group')) {
    register_extended_field_group([
        ...
        'fields' => [
            ...
            Textarea::make("Texte", "footer_secondary_text")->newLines('br')->column(50),
            ButtonAccess::make('Bouton', 'footer_secondary_button')->column(40),
            ...
            Text::make('Copyright', 'footer_copyright')->column(40),
    ...
    register_extended_field_group([
        'title' => 'Réglages page',
        'fields' => [
            TrueFalse::make('Changer la couleur', 'change_color')
                ->helperText('Change la couleur de l\'entête ainsi que la couleur du pied de page'),
        ],
        'location' => [
